...
public class TourRatingServiceIntegrationTest {
    ...
    public void deleteException() {
        assertThrows(NoSuchElementException.class, () -> {service.delete(NOT_A_TOUR_ID, 1234);});
    }
    ...
    public void createNewException() {
        assertThrows(NoSuchElementException.class, () -> {service.createNew(NOT_A_TOUR_ID, CUSTOMER_ID, 2, "it was fair");});
    }
    ...
    public void rateManyProveRollback() {
        assertThrows(DataIntegrityViolationException.class, () -> {int ratings = service.lookupAll().size();
    ...
    public void updateException() throws Exception {
        assertThrows(NoSuchElementException.class, () -> {service.update(1, 1, 1, "one");});
    }
...
//    @Test(expected = NoSuchElementException.class)
    ...
    public void getAverageScoreException() {
        assertThrows(NoSuchElementException.class, () -> {service.getAverageScore(NOT_A_TOUR_ID);});
    }
}