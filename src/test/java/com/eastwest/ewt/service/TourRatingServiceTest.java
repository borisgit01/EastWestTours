...
//    }
    ...
    public void lookupRatingById() {
        ...
        Object o = service.lookupRatingById(TOUR_RATING_ID).get();
        System.out.println("have object of class " + o.getClass().getName());
...
//        when(tourRatingRepositoryMock.findByTourIdAndCustomerId(TOUR_ID,CUSTOMER_ID)).thenReturn(Optional.of(tourRatingMock));
        ...
        List<TourRating> ratings = service.lookupAll();
        System.out.println("have " + ratings.size() + " ratings");
