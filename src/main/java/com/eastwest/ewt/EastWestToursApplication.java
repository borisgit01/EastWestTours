...
import com.eastwest.ewt.service.TourPackageService;
import com.eastwest.ewt.service.TourService;
...
public class EastWestToursApplication implements CommandLineRunner {
	@Value("${ec.importfile}")
	...
	public void run(String... args) throws Exception {
		...
		System.out.println("have " + numOfTours + " tours and " + numOfTourPackages + " packages");
	}
